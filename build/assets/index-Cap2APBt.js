 ...
 */var d0;function OC(){if(d0)return Le;d0=1;var n=Symbol.for("react.element"),e=Symbol.for("react.portal"),t=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),i=Symbol.for("react.profiler"),a=Symbol.for("react.provider"),l=Symbol.for("react.context"),f=Symbol.for("react.forward_ref"),p=Symbol.for("react.suspense"),m=Symbol.for("react.memo"),v=Symbol.for("react.lazy"),x=Symbol.iterator;function E(V){return V===null||typeof V!="object"?null:(V=x&&V[x]||V["@@iterator"],typeof V=="function"?V:null)}var A={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},M=Object.assign,U={};function L(V,H,ae){this.props=V,this.context=H,this.refs=U,this.updater=ae||A}L.prototype.isReactComponent={},L.prototype.setState=function(V,H){if(typeof V!="object"&&typeof V!="function"&&V!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,V,H,"setState")},L.prototype.forceUpdate=function(V){this.updater.enqueueForceUpdate(this,V,"forceUpdate")};function Q(){}Q.prototype=L.prototype;function ee(V,H,ae){this.props=V,this.context=H,this.refs=U,this.updater=ae||A}var oe=ee.prototype=new Q;oe.constructor=ee,M(oe,L.prototype),oe.isPureReactComponent=!0;var G=Array.isArray,ce=Object.prototype.hasOwnProperty,fe={current:null},j={key:!0,ref:!0,__self:!0,__source:!0};function C(V,H,ae){var he,pe={},je=null,be=null;if(H!=null)for(he in H.ref!==void 0&&(be=H.ref),H.key!==void 0&&(je=""+H.key),H)ce.call(H,he)&&!j.hasOwnProperty(he)&&(pe[he]=H[he]);var Ue=arguments.length-2;if(Ue===1)pe.children=ae;else if(1<Ue){for(var Ke=Array(Ue),rt=0;rt<Ue;rt++)Ke[rt]=arguments[rt+2];pe.children=Ke}if(V&&V.defaultProps)for(he in Ue=V.defaultProps,Ue)pe[he]===void 0&&(pe[he]=Ue[he]);return{$$typeof:n,type:V,key:je,ref:be,props:pe,_owner:fe.current}}function S(V,H){return{$$typeof:n,type:V.type,key:H,ref:V.ref,props:V.props,_owner:V._owner}}function b(V){return typeof V=="object"&&V!==null&&V.$$typeof===n}function R(V){var H={"=":"=0",":":"=2"};return"$"+V.replace(/[=:]/g,function(ae){return H[ae]})}var D=/\/+/g;function k(V,H){return typeof V=="object"&&V!==null&&V.key!=null?R(""+V.key):H.toString(36)}function Je(V,H,ae,he,pe){var je=typeof V;(je==="undefined"||je==="boolean")&&(V=null);var be=!1;if(V===null)be=!0;else switch(je){case"string":case"number":be=!0;break;case"object":switch(V.$$typeof){case n:case e:be=!0}}if(be)return be=V,pe=pe(be),V=he===""?"."+k(be,0):he,G(pe)?(ae="",V!=null&&(ae=V.replace(D,"$&/")+"/"),Je(pe,H,ae,"",function(rt){return rt})):pe!=null&&(b(pe)&&(pe=S(pe,ae+(!pe.key||be&&be.key===pe.key?"":(""+pe.key).replace(D,"$&/")+"/")+V)),H.push(pe)),1;if(be=0,he=he===""?".":he+":",G(V))for(var Ue=0;Ue<V.length;Ue++){je=V[Ue];var Ke=he+k(je,Ue);be+=Je(je,H,ae,Ke,pe)}else if(Ke=E(V),typeof Ke=="function")for(V=Ke.call(V),Ue=0;!(je=V.next()).done;)je=je.value,Ke=he+k(je,Ue++),be+=Je(je,H,ae,Ke,pe);else if(je==="object")throw H=String(V),Error("Objects are not valid as a React child (found: "+(H==="[object Object]"?"object with keys {"+Object.keys(V).join(", ")+"}":H)+"). If you meant to render a collection of children, use an array instead.");return be}function Ze(V,H,ae){if(V==null)return V;var he=[],pe=0;return Je(V,he,"","",function(je){return H.call(ae,je,pe++)}),he}function We(V){if(V._status===-1){var H=V._result;H=H(),H.then(function(ae){(V._status===0||V._status===-1)&&(V._status=1,V._result=ae)},function(ae){(V._status===0||V._status===-1)&&(V._status=2,V._result=ae)}),V._status===-1&&(V._status=0,V._result=H)}if(V._status===1)return V._result.default;throw V._result}var Me={current:null},B={transition:null},le={ReactCurrentDispatcher:Me,ReactCurrentBatchConfig:B,ReactCurrentOwner:fe};function te(){throw Error("act(...) is not supported in production builds of React.")}return Le.Children={map:Ze,forEach:function(V,H,ae){Ze(V,function(){H.apply(this,arguments)},ae)},count:function(V){var H=0;return Ze(V,function(){H++}),H},toArray:function(V){return Ze(V,function(H){return H})||[]},only:function(V){if(!b(V))throw Error("React.Children.only expected to receive a single React element child.");return V}},Le.Component=L,Le.Fragment=t,Le.Profiler=i,Le.PureComponent=ee,Le.StrictMode=r,Le.Suspense=p,Le.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=le,Le.act=te,Le.cloneElement=function(V,H,ae){if(V==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+V+".");var he=M({},V.props),pe=V.key,je=V.ref,be=V._owner;if(H!=null){if(H.ref!==void 0&&(je=H.ref,be=fe.current),H.key!==void 0&&(pe=""+H.key),V.type&&V.type.defaultProps)var Ue=V.type.defaultProps;for(Ke in H)ce.call(H,Ke)&&!j.hasOwnProperty(Ke)&&(he[Ke]=H[Ke]===void 0&&Ue!==void 0?Ue[Ke]:H[Ke])}var Ke=arguments.length-2;if(Ke===1)he.children=ae;else if(1<Ke){Ue=Array(Ke);for(var rt=0;rt<Ke;rt++)Ue[rt]=arguments[rt+2];he.children=Ue}return{$$typeof:n,type:V.type,key:pe,ref:je,props:he,_owner:be}},Le.createContext=function(V){return V={$$typeof:l,_currentValue:V,_currentValue2:V,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},V.Provider={$$typeof:a,_context:V},V.Consumer=V},Le.createElement=C,Le.createFactory=function(V){var H=C.bind(null,V);return H.type=V,H},Le.createRef=function(){return{current:null}},Le.forwardRef=function(V){return{$$typeof:f,render:V}},Le.isValidElement=b,Le.lazy=function(V){return{$$typeof:v,_payload:{_status:-1,_result:V},_init:We}},Le.memo=function(V,H){return{$$typeof:m,type:V,compare:H===void 0?null:H}},Le.startTransition=function(V){var H=B.transition;B.transition={};try{V()}finally{B.transition=H}},Le.unstable_act=te,Le.useCallback=function(V,H){return Me.current.useCallback(V,H)},Le.useContext=function(V){return Me.current.useContext(V)},Le.useDebugValue=function(){},Le.useDeferredValue=function(V){return Me.current.useDeferredValue(V)},Le.useEffect=function(V,H){return Me.current.useEffect(V,H)},Le.useId=function(){return Me.current.useId()},Le.useImperativeHandle=function(V,H,ae){return Me.current.useImperativeHandle(V,H,ae)},Le.useInsertionEffect=function(V,H){return Me.current.useInsertionEffect(V,H)},Le.useLayoutEffect=function(V,H){return Me.current.useLayoutEffect(V,H)},Le.useMemo=function(V,H){return Me.current.useMemo(V,H)},Le.useReducer=function(V,H,ae){return Me.current.useReducer(V,H,ae)},Le.useRef=function(V){return Me.current.useRef(V)},Le.useState=function(V){return Me.current.useState(V)},Le.useSyncExternalStore=function(V,H,ae){return Me.current.useSyncExternalStore(V,H,ae)},Le.useTransition=function(){return Me.current.useTransition()},Le.version="18.3.1",Le}var h0;function Cg(){return h0||(h0=1,sm.exports=OC()),sm.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var m0;function LC(){return m0||(m0=1,(function(n){function e(B,le){var te=B.length;B.push(le);e:for(;0<te;){var V=te-1>>>1,H=B[V];if(0<i(H,le))B[V]=le,B[te]=H,te=V;else break e}}function t(B){return B.length===0?null:B[0]}function r(B){if(B.length===0)return null;var le=B[0],te=B.pop();if(te!==le){B[0]=te;e:for(var V=0,H=B.length,ae=H>>>1;V<ae;){var he=2*(V+1)-1,pe=B[he],je=he+1,be=B[je];if(0>i(pe,te))je<H&&0>i(be,pe)?(B[V]=be,B[je]=te,V=je):(B[V]=pe,B[he]=te,V=he);else if(je<H&&0>i(be,te))B[V]=be,B[je]=te,V=je;else break e}}return le}function i(B,le){var te=B.sortIndex-le.sortIndex;return te!==0?te:B.id-le.id}if(typeof performance=="object"&&typeof performance.now=="function"){var a=performance;n.unstable_now=function(){return a.now()}}else{var l=Date,f=l.now();n.unstable_now=function(){return l.now()-f}}var p=[],m=[],v=1,x=null,E=3,A=!1,M=!1,U=!1,L=typeof setTimeout=="function"?setTimeout:null,Q=typeof clearTimeout=="function"?clearTimeout:null,ee=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function oe(B){for(var le=t(m);le!==null;){if(le.callback===null)r(m);else if(le.startTime<=B)r(m),le.sortIndex=le.expirationTime,e(p,le);else break;le=t(m)}}function G(B){if(U=!1,oe(B),!M)if(t(p)!==null)M=!0,We(ce);else{var le=t(m);le!==null&&Me(G,le.startTime-B)}}function ce(B,le){M=!1,U&&(U=!1,Q(C),C=-1),A=!0;var te=E;try{for(oe(le),x=t(p);x!==null&&(!(x.expirationTime>le)||B&&!R());){var V=x.callback;if(typeof V=="function"){x.callback=null,E=x.priorityLevel;var H=V(x.expirationTime<=le);le=n.unstable_now(),typeof H=="function"?x.callback=H:x===t(p)&&r(p),oe(le)}else r(p);x=t(p)}if(x!==null)var ae=!0;else{var he=t(m);he!==null&&Me(G,he.startTime-le),ae=!1}return ae}finally{x=null,E=te,A=!1}}var fe=!1,j=null,C=-1,S=5,b=-1;function R(){return!(n.unstable_now()-b<S)}function D(){if(j!==null){var B=n.unstable_now();b=B;var le=!0;try{le=j(!0,B)}finally{le?k():(fe=!1,j=null)}}else fe=!1}var k;if(typeof ee=="function")k=function(){ee(D)};else if(typeof MessageChannel<"u"){var Je=new MessageChannel,Ze=Je.port2;Je.port1.onmessage=D,k=function(){Ze.postMessage(null)}}else k=function(){L(D,0)};function We(B){j=B,fe||(fe=!0,k())}function Me(B,le){C=L(function(){B(n.unstable_now())},le)}n.unstable_IdlePriority=5,n.unstable_ImmediatePriority=1,n.unstable_LowPriority=4,n.unstable_NormalPriority=3,n.unstable_Profiling=null,n.unstable_UserBlockingPriority=2,n.unstable_cancelCallback=function(B){B.callback=null},n.unstable_continueExecution=function(){M||A||(M=!0,We(ce))},n.unstable_forceFrameRate=function(B){0>B||125<B?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):S=0<B?Math.floor(1e3/B):5},n.unstable_getCurrentPriorityLevel=function(){return E},n.unstable_getFirstCallbackNode=function(){return t(p)},n.unstable_next=function(B){switch(E){case 1:case 2:case 3:var le=3;break;default:le=E}var te=E;E=le;try{return B()}finally{E=te}},n.unstable_pauseExecution=function(){},n.unstable_requestPaint=function(){},n.unstable_runWithPriority=function(B,le){switch(B){case 1:case 2:case 3:case 4:case 5:break;default:B=3}var te=E;E=B;try{return le()}finally{E=te}},n.unstable_scheduleCallback=function(B,le,te){var V=n.unstable_now();switch(typeof te=="object"&&te!==null?(te=te.delay,te=typeof te=="number"&&0<te?V+te:V):te=V,B){case 1:var H=-1;break;case 2:H=250;break;case 5:H=1073741823;break;case 4:H=1e4;break;default:H=5e3}return H=te+H,B={id:v++,callback:le,priorityLevel:B,startTime:te,expirationTime:H,sortIndex:-1},te>V?(B.sortIndex=te,e(m,B),t(p)===null&&B===t(m)&&(U?(Q(C),C=-1):U=!0,Me(G,te-V))):(B.sortIndex=H,e(p,B),M||A||(M=!0,We(ce))),B},n.unstable_shouldYield=R,n.unstable_wrapCallback=function(B){var le=E;return function(){var te=E;E=le;try{return B.apply(this,arguments)}finally{E=te}}}})(am)),am}var g0;function VC(){return g0||(g0=1,om.exports=LC()),om.exports}/**
 * @license React
...
*/var fi,HE;(function(){var n;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(j,C){function S(){}S.prototype=C.prototype,j.D=C.prototype,j.prototype=new S,j.prototype.constructor=j,j.C=function(b,R,D){for(var k=Array(arguments.length-2),Je=2;Je<arguments.length;Je++)k[Je-2]=arguments[Je];return C.prototype[R].apply(b,k)}}function t(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,t),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(j,C,S){S||(S=0);var b=Array(16);if(typeof C=="string")for(var R=0;16>R;++R)b[R]=C.charCodeAt(S++)|C.charCodeAt(S++)<<8|C.charCodeAt(S++)<<16|C.charCodeAt(S++)<<24;else for(R=0;16>R;++R)b[R]=C[S++]|C[S++]<<8|C[S++]<<16|C[S++]<<24;C=j.g[0],S=j.g[1],R=j.g[2];var D=j.g[3],k=C+(D^S&(R^D))+b[0]+3614090360&4294967295;C=S+(k<<7&4294967295|k>>>25),k=D+(R^C&(S^R))+b[1]+3905402710&4294967295,D=C+(k<<12&4294967295|k>>>20),k=R+(S^D&(C^S))+b[2]+606105819&4294967295,R=D+(k<<17&4294967295|k>>>15),k=S+(C^R&(D^C))+b[3]+3250441966&4294967295,S=R+(k<<22&4294967295|k>>>10),k=C+(D^S&(R^D))+b[4]+4118548399&4294967295,C=S+(k<<7&4294967295|k>>>25),k=D+(R^C&(S^R))+b[5]+1200080426&4294967295,D=C+(k<<12&4294967295|k>>>20),k=R+(S^D&(C^S))+b[6]+2821735955&4294967295,R=D+(k<<17&4294967295|k>>>15),k=S+(C^R&(D^C))+b[7]+4249261313&4294967295,S=R+(k<<22&4294967295|k>>>10),k=C+(D^S&(R^D))+b[8]+1770035416&4294967295,C=S+(k<<7&4294967295|k>>>25),k=D+(R^C&(S^R))+b[9]+2336552879&4294967295,D=C+(k<<12&4294967295|k>>>20),k=R+(S^D&(C^S))+b[10]+4294925233&4294967295,R=D+(k<<17&4294967295|k>>>15),k=S+(C^R&(D^C))+b[11]+2304563134&4294967295,S=R+(k<<22&4294967295|k>>>10),k=C+(D^S&(R^D))+b[12]+1804603682&4294967295,C=S+(k<<7&4294967295|k>>>25),k=D+(R^C&(S^R))+b[13]+4254626195&4294967295,D=C+(k<<12&4294967295|k>>>20),k=R+(S^D&(C^S))+b[14]+2792965006&4294967295,R=D+(k<<17&4294967295|k>>>15),k=S+(C^R&(D^C))+b[15]+1236535329&4294967295,S=R+(k<<22&4294967295|k>>>10),k=C+(R^D&(S^R))+b[1]+4129170786&4294967295,C=S+(k<<5&4294967295|k>>>27),k=D+(S^R&(C^S))+b[6]+3225465664&4294967295,D=C+(k<<9&4294967295|k>>>23),k=R+(C^S&(D^C))+b[11]+643717713&4294967295,R=D+(k<<14&4294967295|k>>>18),k=S+(D^C&(R^D))+b[0]+3921069994&4294967295,S=R+(k<<20&4294967295|k>>>12),k=C+(R^D&(S^R))+b[5]+3593408605&4294967295,C=S+(k<<5&4294967295|k>>>27),k=D+(S^R&(C^S))+b[10]+38016083&4294967295,D=C+(k<<9&4294967295|k>>>23),k=R+(C^S&(D^C))+b[15]+3634488961&4294967295,R=D+(k<<14&4294967295|k>>>18),k=S+(D^C&(R^D))+b[4]+3889429448&4294967295,S=R+(k<<20&4294967295|k>>>12),k=C+(R^D&(S^R))+b[9]+568446438&4294967295,C=S+(k<<5&4294967295|k>>>27),k=D+(S^R&(C^S))+b[14]+3275163606&4294967295,D=C+(k<<9&4294967295|k>>>23),k=R+(C^S&(D^C))+b[3]+4107603335&4294967295,R=D+(k<<14&4294967295|k>>>18),k=S+(D^C&(R^D))+b[8]+1163531501&4294967295,S=R+(k<<20&4294967295|k>>>12),k=C+(R^D&(S^R))+b[13]+2850285829&4294967295,C=S+(k<<5&4294967295|k>>>27),k=D+(S^R&(C^S))+b[2]+4243563512&4294967295,D=C+(k<<9&4294967295|k>>>23),k=R+(C^S&(D^C))+b[7]+1735328473&4294967295,R=D+(k<<14&4294967295|k>>>18),k=S+(D^C&(R^D))+b[12]+2368359562&4294967295,S=R+(k<<20&4294967295|k>>>12),k=C+(S^R^D)+b[5]+4294588738&4294967295,C=S+(k<<4&4294967295|k>>>28),k=D+(C^S^R)+b[8]+2272392833&4294967295,D=C+(k<<11&4294967295|k>>>21),k=R+(D^C^S)+b[11]+1839030562&4294967295,R=D+(k<<16&4294967295|k>>>16),k=S+(R^D^C)+b[14]+4259657740&4294967295,S=R+(k<<23&4294967295|k>>>9),k=C+(S^R^D)+b[1]+2763975236&4294967295,C=S+(k<<4&4294967295|k>>>28),k=D+(C^S^R)+b[4]+1272893353&4294967295,D=C+(k<<11&4294967295|k>>>21),k=R+(D^C^S)+b[7]+4139469664&4294967295,R=D+(k<<16&4294967295|k>>>16),k=S+(R^D^C)+b[10]+3200236656&4294967295,S=R+(k<<23&4294967295|k>>>9),k=C+(S^R^D)+b[13]+681279174&4294967295,C=S+(k<<4&4294967295|k>>>28),k=D+(C^S^R)+b[0]+3936430074&4294967295,D=C+(k<<11&4294967295|k>>>21),k=R+(D^C^S)+b[3]+3572445317&4294967295,R=D+(k<<16&4294967295|k>>>16),k=S+(R^D^C)+b[6]+76029189&4294967295,S=R+(k<<23&4294967295|k>>>9),k=C+(S^R^D)+b[9]+3654602809&4294967295,C=S+(k<<4&4294967295|k>>>28),k=D+(C^S^R)+b[12]+3873151461&4294967295,D=C+(k<<11&4294967295|k>>>21),k=R+(D^C^S)+b[15]+530742520&4294967295,R=D+(k<<16&4294967295|k>>>16),k=S+(R^D^C)+b[2]+3299628645&4294967295,S=R+(k<<23&4294967295|k>>>9),k=C+(R^(S|~D))+b[0]+4096336452&4294967295,C=S+(k<<6&4294967295|k>>>26),k=D+(S^(C|~R))+b[7]+1126891415&4294967295,D=C+(k<<10&4294967295|k>>>22),k=R+(C^(D|~S))+b[14]+2878612391&4294967295,R=D+(k<<15&4294967295|k>>>17),k=S+(D^(R|~C))+b[5]+4237533241&4294967295,S=R+(k<<21&4294967295|k>>>11),k=C+(R^(S|~D))+b[12]+1700485571&4294967295,C=S+(k<<6&4294967295|k>>>26),k=D+(S^(C|~R))+b[3]+2399980690&4294967295,D=C+(k<<10&4294967295|k>>>22),k=R+(C^(D|~S))+b[10]+4293915773&4294967295,R=D+(k<<15&4294967295|k>>>17),k=S+(D^(R|~C))+b[1]+2240044497&4294967295,S=R+(k<<21&4294967295|k>>>11),k=C+(R^(S|~D))+b[8]+1873313359&4294967295,C=S+(k<<6&4294967295|k>>>26),k=D+(S^(C|~R))+b[15]+4264355552&4294967295,D=C+(k<<10&4294967295|k>>>22),k=R+(C^(D|~S))+b[6]+2734768916&4294967295,R=D+(k<<15&4294967295|k>>>17),k=S+(D^(R|~C))+b[13]+1309151649&4294967295,S=R+(k<<21&4294967295|k>>>11),k=C+(R^(S|~D))+b[4]+4149444226&4294967295,C=S+(k<<6&4294967295|k>>>26),k=D+(S^(C|~R))+b[11]+3174756917&4294967295,D=C+(k<<10&4294967295|k>>>22),k=R+(C^(D|~S))+b[2]+718787259&4294967295,R=D+(k<<15&4294967295|k>>>17),k=S+(D^(R|~C))+b[9]+3951481745&4294967295,j.g[0]=j.g[0]+C&4294967295,j.g[1]=j.g[1]+(R+(k<<21&4294967295|k>>>11))&4294967295,j.g[2]=j.g[2]+R&4294967295,j.g[3]=j.g[3]+D&4294967295}r.prototype.u=function(j,C){C===void 0&&(C=j.length);for(var S=C-this.blockSize,b=this.B,R=this.h,D=0;D<C;){if(R==0)for(;D<=S;)i(this,j,D),D+=this.blockSize;if(typeof j=="string"){for(;D<C;)if(b[R++]=j.charCodeAt(D++),R==this.blockSize){i(this,b),R=0;break}}else for(;D<C;)if(b[R++]=j[D++],R==this.blockSize){i(this,b),R=0;break}}this.h=R,this.o+=C},r.prototype.v=function(){var j=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);j[0]=128;for(var C=1;C<j.length-8;++C)j[C]=0;var S=8*this.o;for(C=j.length-8;C<j.length;++C)j[C]=S&255,S/=256;for(this.u(j),j=Array(16),C=S=0;4>C;++C)for(var b=0;32>b;b+=8)j[S++]=this.g[C]>>>b&255;return j};function a(j,C){var S=f;return Object.prototype.hasOwnProperty.call(S,j)?S[j]:S[j]=C(j)}function l(j,C){this.h=C;for(var S=[],b=!0,R=j.length-1;0<=R;R--){var D=j[R]|0;b&&D==C||(S[R]=D,b=!1)}this.g=S}var f={};function p(j){return-128<=j&&128>j?a(j,function(C){return new l([C|0],0>C?-1:0)}):new l([j|0],0>j?-1:0)}function m(j){if(isNaN(j)||!isFinite(j))return x;if(0>j)return L(m(-j));for(var C=[],S=1,b=0;j>=S;b++)C[b]=j/S|0,S*=4294967296;return new l(C,0)}function v(j,C){if(j.length==0)throw Error("number format error: empty string");if(C=C||10,2>C||36<C)throw Error("radix out of range: "+C);if(j.charAt(0)=="-")return L(v(j.substring(1),C));if(0<=j.indexOf("-"))throw Error('number format error: interior "-" character');for(var S=m(Math.pow(C,8)),b=x,R=0;R<j.length;R+=8){var D=Math.min(8,j.length-R),k=parseInt(j.substring(R,R+D),C);8>D?(D=m(Math.pow(C,D)),b=b.j(D).add(m(k))):(b=b.j(S),b=b.add(m(k)))}return b}var x=p(0),E=p(1),A=p(16777216);n=l.prototype,n.m=function(){if(U(this))return-L(this).m();for(var j=0,C=1,S=0;S<this.g.length;S++){var b=this.i(S);j+=(0<=b?b:4294967296+b)*C,C*=4294967296}return j},n.toString=function(j){if(j=j||10,2>j||36<j)throw Error("radix out of range: "+j);if(M(this))return"0";if(U(this))return"-"+L(this).toString(j);for(var C=m(Math.pow(j,6)),S=this,b="";;){var R=G(S,C).g;S=Q(S,R.j(C));var D=((0<S.g.length?S.g[0]:S.h)>>>0).toString(j);if(S=R,M(S))return D+b;for(;6>D.length;)D="0"+D;b=D+b}},n.i=function(j){return 0>j?0:j<this.g.length?this.g[j]:this.h};function M(j){if(j.h!=0)return!1;for(var C=0;C<j.g.length;C++)if(j.g[C]!=0)return!1;return!0}function U(j){return j.h==-1}n.l=function(j){return j=Q(this,j),U(j)?-1:M(j)?0:1};function L(j){for(var C=j.g.length,S=[],b=0;b<C;b++)S[b]=~j.g[b];return new l(S,~j.h).add(E)}n.abs=function(){return U(this)?L(this):this},n.add=function(j){for(var C=Math.max(this.g.length,j.g.length),S=[],b=0,R=0;R<=C;R++){var D=b+(this.i(R)&65535)+(j.i(R)&65535),k=(D>>>16)+(this.i(R)>>>16)+(j.i(R)>>>16);b=k>>>16,D&=65535,k&=65535,S[R]=k<<16|D}return new l(S,S[S.length-1]&-2147483648?-1:0)};function Q(j,C){return j.add(L(C))}n.j=function(j){if(M(this)||M(j))return x;if(U(this))return U(j)?L(this).j(L(j)):L(L(this).j(j));if(U(j))return L(this.j(L(j)));if(0>this.l(A)&&0>j.l(A))return m(this.m()*j.m());for(var C=this.g.length+j.g.length,S=[],b=0;b<2*C;b++)S[b]=0;for(b=0;b<this.g.length;b++)for(var R=0;R<j.g.length;R++){var D=this.i(b)>>>16,k=this.i(b)&65535,Je=j.i(R)>>>16,Ze=j.i(R)&65535;S[2*b+2*R]+=k*Ze,ee(S,2*b+2*R),S[2*b+2*R+1]+=D*Ze,ee(S,2*b+2*R+1),S[2*b+2*R+1]+=k*Je,ee(S,2*b+2*R+1),S[2*b+2*R+2]+=D*Je,ee(S,2*b+2*R+2)}for(b=0;b<C;b++)S[b]=S[2*b+1]<<16|S[2*b];for(b=C;b<2*C;b++)S[b]=0;return new l(S,0)};function ee(j,C){for(;(j[C]&65535)!=j[C];)j[C+1]+=j[C]>>>16,j[C]&=65535,C++}function oe(j,C){this.g=j,this.h=C}function G(j,C){if(M(C))throw Error("division by zero");if(M(j))return new oe(x,x);if(U(j))return C=G(L(j),C),new oe(L(C.g),L(C.h));if(U(C))return C=G(j,L(C)),new oe(L(C.g),C.h);if(30<j.g.length){if(U(j)||U(C))throw Error("slowDivide_ only works with positive integers.");for(var S=E,b=C;0>=b.l(j);)S=ce(S),b=ce(b);var R=fe(S,1),D=fe(b,1);for(b=fe(b,2),S=fe(S,2);!M(b);){var k=D.add(b);0>=k.l(j)&&(R=R.add(S),D=k),b=fe(b,1),S=fe(S,1)}return C=Q(j,R.j(C)),new oe(R,C)}for(R=x;0<=j.l(C);){for(S=Math.max(1,Math.floor(j.m()/C.m())),b=Math.ceil(Math.log(S)/Math.LN2),b=48>=b?1:Math.pow(2,b-48),D=m(S),k=D.j(C);U(k)||0<k.l(j);)S-=b,D=m(S),k=D.j(C);M(D)&&(D=E),R=R.add(D),j=Q(j,k)}return new oe(R,j)}n.A=function(j){return G(this,j).h},n.and=function(j){for(var C=Math.max(this.g.length,j.g.length),S=[],b=0;b<C;b++)S[b]=this.i(b)&j.i(b);return new l(S,this.h&j.h)},n.or=function(j){for(var C=Math.max(this.g.length,j.g.length),S=[],b=0;b<C;b++)S[b]=this.i(b)|j.i(b);return new l(S,this.h|j.h)},n.xor=function(j){for(var C=Math.max(this.g.length,j.g.length),S=[],b=0;b<C;b++)S[b]=this.i(b)^j.i(b);return new l(S,this.h^j.h)};function ce(j){for(var C=j.g.length+1,S=[],b=0;b<C;b++)S[b]=j.i(b)<<1|j.i(b-1)>>>31;return new l(S,j.h)}function fe(j,C){var S=C>>5;C%=32;for(var b=j.g.length-S,R=[],D=0;D<b;D++)R[D]=0<C?j.i(D+S)>>>C|j.i(D+S+1)<<32-C:j.i(D+S);return new l(R,j.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,HE=r,l.prototype.add=l.prototype.add,l.prototype.multiply=l.prototype.j,l.prototype.modulo=l.prototype.A,l.prototype.compare=l.prototype.l,l.prototype.toNumber=l.prototype.m,l.prototype.toString=l.prototype.toString,l.prototype.getBits=l.prototype.i,l.fromNumber=m,l.fromString=v,fi=l}).apply(typeof H0<"u"?H0:typeof self<"u"?self:typeof window<"u"?window:{});var jd=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var GE,dc,KE,Gd,$m,QE,YE,XE;(function(){var n,e=typeof Object.defineProperties=="function"?Object.defineProperty:function(u,_,w){return u==Array.prototype||u==Object.prototype||(u[_]=w.value),u};function t(u){u=[typeof globalThis=="object"&&globalThis,u,typeof window=="object"&&window,typeof self=="object"&&self,typeof jd=="object"&&jd];for(var _=0;_<u.length;++_){var w=u[_];if(w&&w.Math==Math)return w}throw Error("Cannot find global object")}var r=t(this);function i(u,_){if(_)e:{var w=r;u=u.split(".");for(var I=0;I<u.length-1;I++){var F=u[I];if(!(F in w))break e;w=w[F]}u=u[u.length-1],I=w[u],_=_(I),_!=I&&_!=null&&e(w,u,{configurable:!0,writable:!0,value:_})}}function a(u,_){u instanceof String&&(u+="");var w=0,I=!1,F={next:function(){if(!I&&w<u.length){var q=w++;return{value:_(q,u[q]),done:!1}}return I=!0,{done:!0,value:void 0}}};return F[Symbol.iterator]=function(){return F},F}i("Array.prototype.values",function(u){return u||function(){return a(this,function(_,w){return w})}});/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var l=l||{},f=this||self;function p(u){var _=typeof u;return _=_!="object"?_:u?Array.isArray(u)?"array":_:"null",_=="array"||_=="object"&&typeof u.length=="number"}function m(u){var _=typeof u;return _=="object"&&u!=null||_=="function"}function v(u,_,w){return u.call.apply(u.bind,arguments)}function x(u,_,w){if(!u)throw Error();if(2<arguments.length){var I=Array.prototype.slice.call(arguments,2);return function(){var F=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(F,I),u.apply(_,F)}}return function(){return u.apply(_,arguments)}}function E(u,_,w){return E=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?v:x,E.apply(null,arguments)}function A(u,_){var w=Array.prototype.slice.call(arguments,1);return function(){var I=w.slice();return I.push.apply(I,arguments),u.apply(this,I)}}function M(u,_){function w(){}w.prototype=_.prototype,u.aa=_.prototype,u.prototype=new w,u.prototype.constructor=u,u.Qb=function(I,F,q){for(var ie=Array(arguments.length-2),nt=2;nt<arguments.length;nt++)ie[nt-2]=arguments[nt];return _.prototype[F].apply(I,ie)}}function U(u){const _=u.length;if(0<_){const w=Array(_);for(let I=0;I<_;I++)w[I]=u[I];return w}return[]}function L(u,_){for(let w=1;w<arguments.length;w++){const I=arguments[w];if(p(I)){const F=u.length||0,q=I.length||0;u.length=F+q;for(let ie=0;ie<q;ie++)u[F+ie]=I[ie]}else u.push(I)}}class Q{constructor(_,w){this.i=_,this.j=w,this.h=0,this.g=null}get(){let _;return 0<this.h?(this.h--,_=this.g,this.g=_.next,_.next=null):_=this.i(),_}}function ee(u){return/^[\s\xa0]*$/.test(u)}function oe(){var u=f.navigator;return u&&(u=u.userAgent)?u:""}function G(u){return G[" "](u),u}G[" "]=function(){};var ce=oe().indexOf("Gecko")!=-1&&!(oe().toLowerCase().indexOf("webkit")!=-1&&oe().indexOf("Edge")==-1)&&!(oe().indexOf("Trident")!=-1||oe().indexOf("MSIE")!=-1)&&oe().indexOf("Edge")==-1;function fe(u,_,w){for(const I in u)_.call(w,u[I],I,u)}function j(u,_){for(const w in u)_.call(void 0,u[w],w,u)}function C(u){const _={};for(const w in u)_[w]=u[w];return _}const S="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function b(u,_){let w,I;for(let F=1;F<arguments.length;F++){I=arguments[F];for(w in I)u[w]=I[w];for(let q=0;q<S.length;q++)w=S[q],Object.prototype.hasOwnProperty.call(I,w)&&(u[w]=I[w])}}function R(u){var _=1;u=u.split(":");const w=[];for(;0<_&&u.length;)w.push(u.shift()),_--;return u.length&&w.push(u.join(":")),w}function D(u){f.setTimeout(()=>{throw u},0)}function k(){var u=le;let _=null;return u.g&&(_=u.g,u.g=u.g.next,u.g||(u.h=null),_.next=null),_}class Je{constructor(){this.h=this.g=null}add(_,w){const I=Ze.get();I.set(_,w),this.h?this.h.next=I:this.g=I,this.h=I}}var Ze=new Q(()=>new We,u=>u.reset());class We{constructor(){this.next=this.g=this.h=null}set(_,w){this.h=_,this.g=w,this.next=null}reset(){this.next=this.g=this.h=null}}let Me,B=!1,le=new Je,te=()=>{const u=f.Promise.resolve(void 0);Me=()=>{u.then(V)}};var V=()=>{for(var u;u=k();){try{u.h.call(u.g)}catch(w){D(w)}var _=Ze;_.j(u),100>_.h&&(_.h++,u.next=_.g,_.g=u)}B=!1};function H(){this.s=this.s,this.C=this.C}H.prototype.s=!1,H.prototype.ma=function(){this.s||(this.s=!0,this.N())},H.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function ae(u,_){this.type=u,this.g=this.target=_,this.defaultPrevented=!1}ae.prototype.h=function(){this.defaultPrevented=!0};var he=(function(){if(!f.addEventListener||!Object.defineProperty)return!1;var u=!1,_=Object.defineProperty({},"passive",{get:function(){u=!0}});try{const w=()=>{};f.addEventListener("test",w,_),f.removeEventListener("test",w,_)}catch{}return u})();function pe(u,_){if(ae.call(this,u?u.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,u){var w=this.type=u.type,I=u.changedTouches&&u.changedTouches.length?u.changedTouches[0]:null;if(this.target=u.target||u.srcElement,this.g=_,_=u.relatedTarget){if(ce){e:{try{G(_.nodeName);var F=!0;break e}catch{}F=!1}F||(_=null)}}else w=="mouseover"?_=u.fromElement:w=="mouseout"&&(_=u.toElement);this.relatedTarget=_,I?(this.clientX=I.clientX!==void 0?I.clientX:I.pageX,this.clientY=I.clientY!==void 0?I.clientY:I.pageY,this.screenX=I.screenX||0,this.screenY=I.screenY||0):(this.clientX=u.clientX!==void 0?u.clientX:u.pageX,this.clientY=u.clientY!==void 0?u.clientY:u.pageY,this.screenX=u.screenX||0,this.screenY=u.screenY||0),this.button=u.button,this.key=u.key||"",this.ctrlKey=u.ctrlKey,this.altKey=u.altKey,this.shiftKey=u.shiftKey,this.metaKey=u.metaKey,this.pointerId=u.pointerId||0,this.pointerType=typeof u.pointerType=="string"?u.pointerType:je[u.pointerType]||"",this.state=u.state,this.i=u,u.defaultPrevented&&pe.aa.h.call(this)}}M(pe,ae);var je={2:"touch",3:"pen",4:"mouse"};pe.prototype.h=function(){pe.aa.h.call(this);var u=this.i;u.preventDefault?u.preventDefault():u.returnValue=!1};var be="closure_listenable_"+(1e6*Math.random()|0),Ue=0;function Ke(u,_,w,I,F){this.listener=u,this.proxy=null,this.src=_,this.type=w,this.capture=!!I,this.ha=F,this.key=++Ue,this.da=this.fa=!1}function rt(u){u.da=!0,u.listener=null,u.proxy=null,u.src=null,u.ha=null}function Pn(u){this.src=u,this.g={},this.h=0}Pn.prototype.add=function(u,_,w,I,F){var q=u.toString();u=this.g[q],u||(u=this.g[q]=[],this.h++);var ie=Rs(u,_,I,F);return-1<ie?(_=u[ie],w||(_.fa=!1)):(_=new Ke(_,this.src,q,!!I,F),_.fa=w,u.push(_)),_};function Zn(u,_){var w=_.type;if(w in u.g){var I=u.g[w],F=Array.prototype.indexOf.call(I,_,void 0),q;(q=0<=F)&&Array.prototype.splice.call(I,F,1),q&&(rt(_),u.g[w].length==0&&(delete u.g[w],u.h--))}}function Rs(u,_,w,I){for(var F=0;F<u.length;++F){var q=u[F];if(!q.da&&q.listener==_&&q.capture==!!w&&q.ha==I)return F}return-1}var Pi="closure_lm_"+(1e6*Math.random()|0),Ao={};function ol(u,_,w,I,F){if(Array.isArray(_)){for(var q=0;q<_.length;q++)ol(u,_[q],w,I,F);return null}return w=cl(w),u&&u[be]?u.K(_,w,m(I)?!!I.capture:!1,F):al(u,_,w,!1,I,F)}function al(u,_,w,I,F,q){if(!_)throw Error("Invalid event type");var ie=m(F)?!!F.capture:!!F,nt=Po(u);if(nt||(u[Pi]=nt=new Pn(u)),w=nt.add(_,w,I,ie,q),w.proxy)return w;if(I=fu(),w.proxy=I,I.src=u,I.listener=w,u.addEventListener)he||(F=ie),F===void 0&&(F=!1),u.addEventListener(_.toString(),I,F);else if(u.attachEvent)u.attachEvent(Zr(_.toString()),I);else if(u.addListener&&u.removeListener)u.addListener(I);else throw Error("addEventListener and attachEvent are unavailable.");return w}function fu(){function u(w){return _.call(u.src,u.listener,w)}const _=ll;return u}function Ro(u,_,w,I,F){if(Array.isArray(_))for(var q=0;q<_.length;q++)Ro(u,_[q],w,I,F);else I=m(I)?!!I.capture:!!I,w=cl(w),u&&u[be]?(u=u.i,_=String(_).toString(),_ in u.g&&(q=u.g[_],w=Rs(q,w,I,F),-1<w&&(rt(q[w]),Array.prototype.splice.call(q,w,1),q.length==0&&(delete u.g[_],u.h--)))):u&&(u=Po(u))&&(_=u.g[_.toString()],u=-1,_&&(u=Rs(_,w,I,F)),(w=-1<u?_[u]:null)&&Jr(w))}function Jr(u){if(typeof u!="number"&&u&&!u.da){var _=u.src;if(_&&_[be])Zn(_.i,u);else{var w=u.type,I=u.proxy;_.removeEventListener?_.removeEventListener(w,I,u.capture):_.detachEvent?_.detachEvent(Zr(w),I):_.addListener&&_.removeListener&&_.removeListener(I),(w=Po(_))?(Zn(w,u),w.h==0&&(w.src=null,_[Pi]=null)):rt(u)}}}function Zr(u){return u in Ao?Ao[u]:Ao[u]="on"+u}function ll(u,_){if(u.da)u=!0;else{_=new pe(_,this);var w=u.listener,I=u.ha||u.src;u.fa&&Jr(u),u=w.call(I,_)}return u}function Po(u){return u=u[Pi],u instanceof Pn?u:null}var jo="__closure_events_fn_"+(1e9*Math.random()>>>0);function cl(u){return typeof u=="function"?u:(u[jo]||(u[jo]=function(_){return u.handleEvent(_)}),u[jo])}function St(){H.call(this),this.i=new Pn(this),this.M=this,this.F=null}M(St,H),St.prototype[be]=!0,St.prototype.removeEventListener=function(u,_,w,I){Ro(this,u,_,w,I)};function At(u,_){var w,I=u.F;if(I)for(w=[];I;I=I.F)w.push(I);if(u=u.M,I=_.type||_,typeof _=="string")_=new ae(_,u);else if(_ instanceof ae)_.target=_.target||u;else{var F=_;_=new ae(I,u),b(_,F)}if(F=!0,w)for(var q=w.length-1;0<=q;q--){var ie=_.g=w[q];F=es(ie,I,!0,_)&&F}if(ie=_.g=u,F=es(ie,I,!0,_)&&F,F=es(ie,I,!1,_)&&F,w)for(q=0;q<w.length;q++)ie=_.g=w[q],F=es(ie,I,!1,_)&&F}St.prototype.N=function(){if(St.aa.N.call(this),this.i){var u=this.i,_;for(_ in u.g){for(var w=u.g[_],I=0;I<w.length;I++)rt(w[I]);delete u.g[_],u.h--}}this.F=null},St.prototype.K=function(u,_,w,I){return this.i.add(String(u),_,!1,w,I)},St.prototype.L=function(u,_,w,I){return this.i.add(String(u),_,!0,w,I)};function es(u,_,w,I){if(_=u.i.g[String(_)],!_)return!0;_=_.concat();for(var F=!0,q=0;q<_.length;++q){var ie=_[q];if(ie&&!ie.da&&ie.capture==w){var nt=ie.listener,Rt=ie.ha||ie.src;ie.fa&&Zn(u.i,ie),F=nt.call(Rt,I)!==!1&&F}}return F&&!I.defaultPrevented}function ul(u,_,w){if(typeof u=="function")w&&(u=E(u,w));else if(u&&typeof u.handleEvent=="function")u=E(u.handleEvent,u);else throw Error("Invalid listener argument");return 2147483647<Number(_)?-1:f.setTimeout(u,_||0)}function Ps(u){u.g=ul(()=>{u.g=null,u.i&&(u.i=!1,Ps(u))},u.l);const _=u.h;u.h=null,u.m.apply(null,_)}class ji extends H{constructor(_,w){super(),this.m=_,this.l=w,this.h=null,this.i=!1,this.g=null}j(_){this.h=arguments,this.g?this.i=!0:Ps(this)}N(){super.N(),this.g&&(f.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function Oi(u){H.call(this),this.h=u,this.g={}}M(Oi,H);var dl=[];function hl(u){fe(u.g,function(_,w){this.g.hasOwnProperty(w)&&Jr(_)},u),u.g={}}Oi.prototype.N=function(){Oi.aa.N.call(this),hl(this)},Oi.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var fl=f.JSON.stringify,pl=f.JSON.parse,ml=class{stringify(u){return f.JSON.stringify(u,void 0)}parse(u){return f.JSON.parse(u,void 0)}};function Di(){}Di.prototype.h=null;function Oo(u){return u.h||(u.h=u.i())}function Do(){}var Bn={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function br(){ae.call(this,"d")}M(br,ae);function Mo(){ae.call(this,"c")}M(Mo,ae);var Ir={},gl=null;function Mi(){return gl=gl||new St}Ir.La="serverreachability";function _l(u){ae.call(this,Ir.La,u)}M(_l,ae);function ts(u){const _=Mi();At(_,new _l(_))}Ir.STAT_EVENT="statevent";function yl(u,_){ae.call(this,Ir.STAT_EVENT,u),this.stat=_}M(yl,ae);function xt(u){const _=Mi();At(_,new yl(_,u))}Ir.Ma="timingevent";function Lo(u,_){ae.call(this,Ir.Ma,u),this.size=_}M(Lo,ae);function er(u,_){if(typeof u!="function")throw Error("Fn must not be null and must be a function");return f.setTimeout(function(){u()},_)}function Li(){this.g=!0}Li.prototype.xa=function(){this.g=!1};function Vi(u,_,w,I,F,q){u.info(function(){if(u.g)if(q)for(var ie="",nt=q.split("&"),Rt=0;Rt<nt.length;Rt++){var He=nt[Rt].split("=");if(1<He.length){var Ut=He[0];He=He[1];var bt=Ut.split("_");ie=2<=bt.length&&bt[1]=="type"?ie+(Ut+"="+He+"&"):ie+(Ut+"=redacted&")}}else ie=null;else ie=q;return"XMLHTTP REQ ("+I+") [attempt "+F+"]: "+_+`
`+w+`
`+ie})}function Vo(u,_,w,I,F,q,ie){u.info(function(){return"XMLHTTP RESP ("+I+") [ attempt "+F+"]: "+_+`
`+w+`
`+q+" "+ie})}function tr(u,_,w,I){u.info(function(){return"XMLHTTP TEXT ("+_+"): "+Rf(u,w)+(I?" "+I:"")})}function vl(u,_){u.info(function(){return"TIMEOUT: "+_})}Li.prototype.info=function(){};function Rf(u,_){if(!u.g)return _;if(!_)return null;try{var w=JSON.parse(_);if(w){for(u=0;u<w.length;u++)if(Array.isArray(w[u])){var I=w[u];if(!(2>I.length)){var F=I[1];if(Array.isArray(F)&&!(1>F.length)){var q=F[0];if(q!="noop"&&q!="stop"&&q!="close")for(var ie=1;ie<F.length;ie++)F[ie]=""}}}}return fl(w)}catch{return _}}var Fo={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},pu={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},nr;function Fi(){}M(Fi,Di),Fi.prototype.g=function(){return new XMLHttpRequest},Fi.prototype.i=function(){return{}},nr=new Fi;function rr(u,_,w,I){this.j=u,this.i=_,this.l=w,this.R=I||1,this.U=new Oi(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new mu}function mu(){this.i=null,this.g="",this.h=!1}var wl={},Uo={};function zo(u,_,w){u.L=1,u.v=Ls(On(_)),u.m=w,u.P=!0,xl(u,null)}function xl(u,_){u.F=Date.now(),at(u),u.A=On(u.v);var w=u.A,I=u.R;Array.isArray(I)||(I=[String(I)]),Fs(w.i,"t",I),u.C=0,w=u.j.J,u.h=new mu,u.g=ju(u.j,w?_:null,!u.m),0<u.O&&(u.M=new ji(E(u.Y,u,u.g),u.O)),_=u.U,w=u.g,I=u.ca;var F="readystatechange";Array.isArray(F)||(F&&(dl[0]=F.toString()),F=dl);for(var q=0;q<F.length;q++){var ie=ol(w,F[q],I||_.handleEvent,!1,_.h||_);if(!ie)break;_.g[ie.key]=ie}_=u.H?C(u.H):{},u.m?(u.u||(u.u="POST"),_["Content-Type"]="application/x-www-form-urlencoded",u.g.ea(u.A,u.u,u.m,_)):(u.u="GET",u.g.ea(u.A,u.u,null,_)),ts(),Vi(u.i,u.u,u.A,u.l,u.R,u.m)}rr.prototype.ca=function(u){u=u.target;const _=this.M;_&&gn(u)==3?_.j():this.Y(u)},rr.prototype.Y=function(u){try{if(u==this.g)e:{const bt=gn(this.g);var _=this.g.Ba();const qn=this.g.Z();if(!(3>bt)&&(bt!=3||this.g&&(this.h.h||this.g.oa()||Nl(this.g)))){this.J||bt!=4||_==7||(_==8||0>=qn?ts(3):ts(2)),Ui(this);var w=this.g.Z();this.X=w;t:if(gu(this)){var I=Nl(this.g);u="";var F=I.length,q=gn(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){$n(this),js(this);var ie="";break t}this.h.i=new f.TextDecoder}for(_=0;_<F;_++)this.h.h=!0,u+=this.h.i.decode(I[_],{stream:!(q&&_==F-1)});I.length=0,this.h.g+=u,this.C=0,ie=this.h.g}else ie=this.g.oa();if(this.o=w==200,Vo(this.i,this.u,this.A,this.l,this.R,bt,w),this.o){if(this.T&&!this.K){t:{if(this.g){var nt,Rt=this.g;if((nt=Rt.g?Rt.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!ee(nt)){var He=nt;break t}}He=null}if(w=He)tr(this.i,this.l,w,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,El(this,w);else{this.o=!1,this.s=3,xt(12),$n(this),js(this);break e}}if(this.P){w=!0;let Mn;for(;!this.J&&this.C<ie.length;)if(Mn=Pf(this,ie),Mn==Uo){bt==4&&(this.s=4,xt(14),w=!1),tr(this.i,this.l,null,"[Incomplete Response]");break}else if(Mn==wl){this.s=4,xt(15),tr(this.i,this.l,ie,"[Invalid Chunk]"),w=!1;break}else tr(this.i,this.l,Mn,null),El(this,Mn);if(gu(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),bt!=4||ie.length!=0||this.h.h||(this.s=1,xt(16),w=!1),this.o=this.o&&w,!w)tr(this.i,this.l,ie,"[Invalid Chunked Response]"),$n(this),js(this);else if(0<ie.length&&!this.W){this.W=!0;var Ut=this.j;Ut.g==this&&Ut.ba&&!Ut.M&&(Ut.j.info("Great, no buffering proxy detected. Bytes received: "+ie.length),Sl(Ut),Ut.M=!0,xt(11))}}else tr(this.i,this.l,ie,null),El(this,ie);bt==4&&$n(this),this.o&&!this.J&&(bt==4?Jo(this.j,this):(this.o=!1,at(this)))}else Go(this.g),w==400&&0<ie.indexOf("Unknown SID")?(this.s=3,xt(12)):(this.s=0,xt(13)),$n(this),js(this)}}}catch{}finally{}};function gu(u){return u.g?u.u=="GET"&&u.L!=2&&u.j.Ca:!1}function Pf(u,_){var w=u.C,I=_.indexOf(`
`,w);return I==-1?Uo:(w=Number(_.substring(w,I)),isNaN(w)?wl:(I+=1,I+w>_.length?Uo:(_=_.slice(I,I+w),u.C=I+w,_)))}rr.prototype.cancel=function(){this.J=!0,$n(this)};function at(u){u.S=Date.now()+u.I,_u(u,u.I)}function _u(u,_){if(u.B!=null)throw Error("WatchDog timer not null");u.B=er(E(u.ba,u),_)}function Ui(u){u.B&&(f.clearTimeout(u.B),u.B=null)}rr.prototype.ba=function(){this.B=null;const u=Date.now();0<=u-this.S?(vl(this.i,this.A),this.L!=2&&(ts(),xt(17)),$n(this),this.s=2,js(this)):_u(this,this.S-u)};function js(u){u.j.G==0||u.J||Jo(u.j,u)}function $n(u){Ui(u);var _=u.M;_&&typeof _.ma=="function"&&_.ma(),u.M=null,hl(u.U),u.g&&(_=u.g,u.g=null,_.abort(),_.ma())}function El(u,_){try{var w=u.j;if(w.G!=0&&(w.g==u||dn(w.h,u))){if(!u.K&&dn(w.h,u)&&w.G==3){try{var I=w.Da.g.parse(_)}catch{I=null}if(Array.isArray(I)&&I.length==3){var F=I;if(F[0]==0){e:if(!w.u){if(w.g)if(w.g.F+3e3<u.F)Xo(w),lr(w);else break e;Yo(w),xt(18)}}else w.za=F[1],0<w.za-w.T&&37500>F[2]&&w.F&&w.v==0&&!w.C&&(w.C=er(E(w.Za,w),6e3));if(1>=vu(w.h)&&w.ca){try{w.ca()}catch{}w.ca=void 0}}else os(w,11)}else if((u.K||w.g==u)&&Xo(w),!ee(_))for(F=w.Da.g.parse(_),_=0;_<F.length;_++){let He=F[_];if(w.T=He[0],He=He[1],w.G==2)if(He[0]=="c"){w.K=He[1],w.ia=He[2];const Ut=He[3];Ut!=null&&(w.la=Ut,w.j.info("VER="+w.la));const bt=He[4];bt!=null&&(w.Aa=bt,w.j.info("SVER="+w.Aa));const qn=He[5];qn!=null&&typeof qn=="number"&&0<qn&&(I=1.5*qn,w.L=I,w.j.info("backChannelRequestTimeoutMs_="+I)),I=w;const Mn=u.g;if(Mn){const Gi=Mn.g?Mn.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(Gi){var q=I.h;q.g||Gi.indexOf("spdy")==-1&&Gi.indexOf("quic")==-1&&Gi.indexOf("h2")==-1||(q.j=q.l,q.g=new Set,q.h&&(Tl(q,q.h),q.h=null))}if(I.D){const ea=Mn.g?Mn.g.getResponseHeader("X-HTTP-Session-Id"):null;ea&&(I.ya=ea,st(I.I,I.D,ea))}}w.G=3,w.l&&w.l.ua(),w.ba&&(w.R=Date.now()-u.F,w.j.info("Handshake RTT: "+w.R+"ms")),I=w;var ie=u;if(I.qa=Pu(I,I.J?I.ia:null,I.W),ie.K){wu(I.h,ie);var nt=ie,Rt=I.L;Rt&&(nt.I=Rt),nt.B&&(Ui(nt),at(nt)),I.g=ie}else Hi(I);0<w.i.length&&Sr(w)}else He[0]!="stop"&&He[0]!="close"||os(w,7);else w.G==3&&(He[0]=="stop"||He[0]=="close"?He[0]=="stop"?os(w,7):Yt(w):He[0]!="noop"&&w.l&&w.l.ta(He),w.v=0)}}ts(4)}catch{}}var yu=class{constructor(u,_){this.g=u,this.map=_}};function zi(u){this.l=u||10,f.PerformanceNavigationTiming?(u=f.performance.getEntriesByType("navigation"),u=0<u.length&&(u[0].nextHopProtocol=="hq"||u[0].nextHopProtocol=="h2")):u=!!(f.chrome&&f.chrome.loadTimes&&f.chrome.loadTimes()&&f.chrome.loadTimes().wasFetchedViaSpdy),this.j=u?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function jn(u){return u.h?!0:u.g?u.g.size>=u.j:!1}function vu(u){return u.h?1:u.g?u.g.size:0}function dn(u,_){return u.h?u.h==_:u.g?u.g.has(_):!1}function Tl(u,_){u.g?u.g.add(_):u.h=_}function wu(u,_){u.h&&u.h==_?u.h=null:u.g&&u.g.has(_)&&u.g.delete(_)}zi.prototype.cancel=function(){if(this.i=xu(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const u of this.g.values())u.cancel();this.g.clear()}};function xu(u){if(u.h!=null)return u.i.concat(u.h.D);if(u.g!=null&&u.g.size!==0){let _=u.i;for(const w of u.g.values())_=_.concat(w.D);return _}return U(u.i)}function Bo(u){if(u.V&&typeof u.V=="function")return u.V();if(typeof Map<"u"&&u instanceof Map||typeof Set<"u"&&u instanceof Set)return Array.from(u.values());if(typeof u=="string")return u.split("");if(p(u)){for(var _=[],w=u.length,I=0;I<w;I++)_.push(u[I]);return _}_=[],w=0;for(I in u)_[w++]=u[I];return _}function $o(u){if(u.na&&typeof u.na=="function")return u.na();if(!u.V||typeof u.V!="function"){if(typeof Map<"u"&&u instanceof Map)return Array.from(u.keys());if(!(typeof Set<"u"&&u instanceof Set)){if(p(u)||typeof u=="string"){var _=[];u=u.length;for(var w=0;w<u;w++)_.push(w);return _}_=[],w=0;for(const I in u)_[w++]=I;return _}}}function Os(u,_){if(u.forEach&&typeof u.forEach=="function")u.forEach(_,void 0);else if(p(u)||typeof u=="string")Array.prototype.forEach.call(u,_,void 0);else for(var w=$o(u),I=Bo(u),F=I.length,q=0;q<F;q++)_.call(void 0,I[q],w&&w[q],u)}var Bi=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function jf(u,_){if(u){u=u.split("&");for(var w=0;w<u.length;w++){var I=u[w].indexOf("="),F=null;if(0<=I){var q=u[w].substring(0,I);F=u[w].substring(I+1)}else q=u[w];_(q,F?decodeURIComponent(F.replace(/\+/g," ")):"")}}}function ns(u){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,u instanceof ns){this.h=u.h,$i(this,u.j),this.o=u.o,this.g=u.g,Ds(this,u.s),this.l=u.l;var _=u.i,w=new Cr;w.i=_.i,_.g&&(w.g=new Map(_.g),w.h=_.h),Ms(this,w),this.m=u.m}else u&&(_=String(u).match(Bi))?(this.h=!1,$i(this,_[1]||"",!0),this.o=qe(_[2]||""),this.g=qe(_[3]||"",!0),Ds(this,_[4]),this.l=qe(_[5]||"",!0),Ms(this,_[6]||"",!0),this.m=qe(_[7]||"")):(this.h=!1,this.i=new Cr(null,this.h))}ns.prototype.toString=function(){var u=[],_=this.j;_&&u.push(Vs(_,Wo,!0),":");var w=this.g;return(w||_=="file")&&(u.push("//"),(_=this.o)&&u.push(Vs(_,Wo,!0),"@"),u.push(encodeURIComponent(String(w)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),w=this.s,w!=null&&u.push(":",String(w))),(w=this.l)&&(this.g&&w.charAt(0)!="/"&&u.push("/"),u.push(Vs(w,w.charAt(0)=="/"?bu:Tu,!0))),(w=this.i.toString())&&u.push("?",w),(w=this.m)&&u.push("#",Vs(w,bl)),u.join("")};function On(u){return new ns(u)}function $i(u,_,w){u.j=w?qe(_,!0):_,u.j&&(u.j=u.j.replace(/:$/,""))}function Ds(u,_){if(_){if(_=Number(_),isNaN(_)||0>_)throw Error("Bad port number "+_);u.s=_}else u.s=null}function Ms(u,_,w){_ instanceof Cr?(u.i=_,Nr(u.i,u.h)):(w||(_=Vs(_,Iu)),u.i=new Cr(_,u.h))}function st(u,_,w){u.i.set(_,w)}function Ls(u){return st(u,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),u}function qe(u,_){return u?_?decodeURI(u.replace(/%25/g,"%2525")):decodeURIComponent(u):""}function Vs(u,_,w){return typeof u=="string"?(u=encodeURI(u).replace(_,Eu),w&&(u=u.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),u):null}function Eu(u){return u=u.charCodeAt(0),"%"+(u>>4&15).toString(16)+(u&15).toString(16)}var Wo=/[#\/\?@]/g,Tu=/[#\?:]/g,bu=/[#\?]/g,Iu=/[#\?@]/g,bl=/#/g;function Cr(u,_){this.h=this.g=null,this.i=u||null,this.j=!!_}function Qt(u){u.g||(u.g=new Map,u.h=0,u.i&&jf(u.i,function(_,w){u.add(decodeURIComponent(_.replace(/\+/g," ")),w)}))}n=Cr.prototype,n.add=function(u,_){Qt(this),this.i=null,u=Wn(this,u);var w=this.g.get(u);return w||this.g.set(u,w=[]),w.push(_),this.h+=1,this};function sr(u,_){Qt(u),_=Wn(u,_),u.g.has(_)&&(u.i=null,u.h-=u.g.get(_).length,u.g.delete(_))}function ir(u,_){return Qt(u),_=Wn(u,_),u.g.has(_)}n.forEach=function(u,_){Qt(this),this.g.forEach(function(w,I){w.forEach(function(F){u.call(_,F,I,this)},this)},this)},n.na=function(){Qt(this);const u=Array.from(this.g.values()),_=Array.from(this.g.keys()),w=[];for(let I=0;I<_.length;I++){const F=u[I];for(let q=0;q<F.length;q++)w.push(_[I])}return w},n.V=function(u){Qt(this);let _=[];if(typeof u=="string")ir(this,u)&&(_=_.concat(this.g.get(Wn(this,u))));else{u=Array.from(this.g.values());for(let w=0;w<u.length;w++)_=_.concat(u[w])}return _},n.set=function(u,_){return Qt(this),this.i=null,u=Wn(this,u),ir(this,u)&&(this.h-=this.g.get(u).length),this.g.set(u,[_]),this.h+=1,this},n.get=function(u,_){return u?(u=this.V(u),0<u.length?String(u[0]):_):_};function Fs(u,_,w){sr(u,_),0<w.length&&(u.i=null,u.g.set(Wn(u,_),U(w)),u.h+=w.length)}n.toString=function(){if(this.i)return this.i;if(!this.g)return"";const u=[],_=Array.from(this.g.keys());for(var w=0;w<_.length;w++){var I=_[w];const q=encodeURIComponent(String(I)),ie=this.V(I);for(I=0;I<ie.length;I++){var F=q;ie[I]!==""&&(F+="="+encodeURIComponent(String(ie[I]))),u.push(F)}}return this.i=u.join("&")};function Wn(u,_){return _=String(_),u.j&&(_=_.toLowerCase()),_}function Nr(u,_){_&&!u.j&&(Qt(u),u.i=null,u.g.forEach(function(w,I){var F=I.toLowerCase();I!=F&&(sr(this,I),Fs(this,F,w))},u)),u.j=_}function Of(u,_){const w=new Li;if(f.Image){const I=new Image;I.onload=A(mn,w,"TestLoadImage: loaded",!0,_,I),I.onerror=A(mn,w,"TestLoadImage: error",!1,_,I),I.onabort=A(mn,w,"TestLoadImage: abort",!1,_,I),I.ontimeout=A(mn,w,"TestLoadImage: timeout",!1,_,I),f.setTimeout(function(){I.ontimeout&&I.ontimeout()},1e4),I.src=u}else _(!1)}function Cu(u,_){const w=new Li,I=new AbortController,F=setTimeout(()=>{I.abort(),mn(w,"TestPingServer: timeout",!1,_)},1e4);fetch(u,{signal:I.signal}).then(q=>{clearTimeout(F),q.ok?mn(w,"TestPingServer: ok",!0,_):mn(w,"TestPingServer: server error",!1,_)}).catch(()=>{clearTimeout(F),mn(w,"TestPingServer: error",!1,_)})}function mn(u,_,w,I,F){try{F&&(F.onload=null,F.onerror=null,F.onabort=null,F.ontimeout=null),I(w)}catch{}}function Df(){this.g=new ml}function Nu(u,_,w){const I=w||"";try{Os(u,function(F,q){let ie=F;m(F)&&(ie=fl(F)),_.push(I+q+"="+encodeURIComponent(ie))})}catch(F){throw _.push(I+"type="+encodeURIComponent("_badmap")),F}}function rs(u){this.l=u.Ub||null,this.j=u.eb||!1}M(rs,Di),rs.prototype.g=function(){return new Wi(this.l,this.j)},rs.prototype.i=(function(u){return function(){return u}})({});function Wi(u,_){St.call(this),this.D=u,this.o=_,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}M(Wi,St),n=Wi.prototype,n.open=function(u,_){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=u,this.A=_,this.readyState=1,ar(this)},n.send=function(u){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const _={headers:this.u,method:this.B,credentials:this.m,cache:void 0};u&&(_.body=u),(this.D||f).fetch(new Request(this.A,_)).then(this.Sa.bind(this),this.ga.bind(this))},n.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,or(this)),this.readyState=0},n.Sa=function(u){if(this.g&&(this.l=u,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=u.headers,this.readyState=2,ar(this)),this.g&&(this.readyState=3,ar(this),this.g)))if(this.responseType==="arraybuffer")u.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof f.ReadableStream<"u"&&"body"in u){if(this.j=u.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;ku(this)}else u.text().then(this.Ra.bind(this),this.ga.bind(this))};function ku(u){u.j.read().then(u.Pa.bind(u)).catch(u.ga.bind(u))}n.Pa=function(u){if(this.g){if(this.o&&u.value)this.response.push(u.value);else if(!this.o){var _=u.value?u.value:new Uint8Array(0);(_=this.v.decode(_,{stream:!u.done}))&&(this.response=this.responseText+=_)}u.done?or(this):ar(this),this.readyState==3&&ku(this)}},n.Ra=function(u){this.g&&(this.response=this.responseText=u,or(this))},n.Qa=function(u){this.g&&(this.response=u,or(this))},n.ga=function(){this.g&&or(this)};function or(u){u.readyState=4,u.l=null,u.j=null,u.v=null,ar(u)}n.setRequestHeader=function(u,_){this.u.append(u,_)},n.getResponseHeader=function(u){return this.h&&this.h.get(u.toLowerCase())||""},n.getAllResponseHeaders=function(){if(!this.h)return"";const u=[],_=this.h.entries();for(var w=_.next();!w.done;)w=w.value,u.push(w[0]+": "+w[1]),w=_.next();return u.join(`\r
`)};function ar(u){u.onreadystatechange&&u.onreadystatechange.call(u)}Object.defineProperty(Wi.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(u){this.m=u?"include":"same-origin"}});function ss(u){let _="";return fe(u,function(w,I){_+=I,_+=":",_+=w,_+=`\r
`}),_}function Us(u,_,w){e:{for(I in w){var I=!1;break e}I=!0}I||(w=ss(w),typeof u=="string"?w!=null&&encodeURIComponent(String(w)):st(u,_,w))}function mt(u){St.call(this),this.headers=new Map,this.o=u||null,this.h=!1,this.v=this.g=null,this.D="",this.m=0,this.l="",this.j=this.B=this.u=this.A=!1,this.I=null,this.H="",this.J=!1}M(mt,St);var Mf=/^https?$/i,Il=["POST","PUT"];n=mt.prototype,n.Ha=function(u){this.J=u},n.ea=function(u,_,w,I){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+u);_=_?_.toUpperCase():"GET",this.D=u,this.l="",this.m=0,this.A=!1,this.h=!0,this.g=this.o?this.o.g():nr.g(),this.v=this.o?Oo(this.o):Oo(nr),this.g.onreadystatechange=E(this.Ea,this);try{this.B=!0,this.g.open(_,String(u),!0),this.B=!1}catch(q){qi(this,q);return}if(u=w||"",w=new Map(this.headers),I)if(Object.getPrototypeOf(I)===Object.prototype)for(var F in I)w.set(F,I[F]);else if(typeof I.keys=="function"&&typeof I.get=="function")for(const q of I.keys())w.set(q,I.get(q));else throw Error("Unknown input type for opt_headers: "+String(I));I=Array.from(w.keys()).find(q=>q.toLowerCase()=="content-type"),F=f.FormData&&u instanceof f.FormData,!(0<=Array.prototype.indexOf.call(Il,_,void 0))||I||F||w.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[q,ie]of w)this.g.setRequestHeader(q,ie);this.H&&(this.g.responseType=this.H),"withCredentials"in this.g&&this.g.withCredentials!==this.J&&(this.g.withCredentials=this.J);try{Ho(this),this.u=!0,this.g.send(u),this.u=!1}catch(q){qi(this,q)}};function qi(u,_){u.h=!1,u.g&&(u.j=!0,u.g.abort(),u.j=!1),u.l=_,u.m=5,qo(u),Dn(u)}function qo(u){u.A||(u.A=!0,At(u,"complete"),At(u,"error"))}n.abort=function(u){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.m=u||7,At(this,"complete"),At(this,"abort"),Dn(this))},n.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),Dn(this,!0)),mt.aa.N.call(this)},n.Ea=function(){this.s||(this.B||this.u||this.j?Cl(this):this.bb())},n.bb=function(){Cl(this)};function Cl(u){if(u.h&&typeof l<"u"&&(!u.v[1]||gn(u)!=4||u.Z()!=2)){if(u.u&&gn(u)==4)ul(u.Ea,0,u);else if(At(u,"readystatechange"),gn(u)==4){u.h=!1;try{const ie=u.Z();e:switch(ie){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var _=!0;break e;default:_=!1}var w;if(!(w=_)){var I;if(I=ie===0){var F=String(u.D).match(Bi)[1]||null;!F&&f.self&&f.self.location&&(F=f.self.location.protocol.slice(0,-1)),I=!Mf.test(F?F.toLowerCase():"")}w=I}if(w)At(u,"complete"),At(u,"success");else{u.m=6;try{var q=2<gn(u)?u.g.statusText:""}catch{q=""}u.l=q+" ["+u.Z()+"]",qo(u)}}finally{Dn(u)}}}}function Dn(u,_){if(u.g){Ho(u);const w=u.g,I=u.v[0]?()=>{}:null;u.g=null,u.v=null,_||At(u,"ready");try{w.onreadystatechange=I}catch{}}}function Ho(u){u.I&&(f.clearTimeout(u.I),u.I=null)}n.isActive=function(){return!!this.g};function gn(u){return u.g?u.g.readyState:0}n.Z=function(){try{return 2<gn(this)?this.g.status:-1}catch{return-1}},n.oa=function(){try{return this.g?this.g.responseText:""}catch{return""}},n.Oa=function(u){if(this.g){var _=this.g.responseText;return u&&_.indexOf(u)==0&&(_=_.substring(u.length)),pl(_)}};function Nl(u){try{if(!u.g)return null;if("response"in u.g)return u.g.response;switch(u.H){case"":case"text":return u.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in u.g)return u.g.mozResponseArrayBuffer}return null}catch{return null}}function Go(u){const _={};u=(u.g&&2<=gn(u)&&u.g.getAllResponseHeaders()||"").split(`\r
`);for(let I=0;I<u.length;I++){if(ee(u[I]))continue;var w=R(u[I]);const F=w[0];if(w=w[1],typeof w!="string")continue;w=w.trim();const q=_[F]||[];_[F]=q,q.push(w)}j(_,function(I){return I.join(", ")})}n.Ba=function(){return this.m},n.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function kr(u,_,w){return w&&w.internalChannelParams&&w.internalChannelParams[u]||_}function kl(u){this.Aa=0,this.i=[],this.j=new Li,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=kr("failFast",!1,u),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=kr("baseRetryDelayMs",5e3,u),this.cb=kr("retryDelaySeedMs",1e4,u),this.Wa=kr("forwardChannelMaxRetries",2,u),this.wa=kr("forwardChannelRequestTimeoutMs",2e4,u),this.pa=u&&u.xmlHttpFactory||void 0,this.Xa=u&&u.Tb||void 0,this.Ca=u&&u.useFetchStreams||!1,this.L=void 0,this.J=u&&u.supportsCrossDomainXhr||!1,this.K="",this.h=new zi(u&&u.concurrentRequestLimit),this.Da=new Df,this.P=u&&u.fastHandshake||!1,this.O=u&&u.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=u&&u.Rb||!1,u&&u.xa&&this.j.xa(),u&&u.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&u&&u.detectBufferingProxy||!1,this.ja=void 0,u&&u.longPollingTimeout&&0<u.longPollingTimeout&&(this.ja=u.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}n=kl.prototype,n.la=8,n.G=1,n.connect=function(u,_,w,I){xt(0),this.W=u,this.H=_||{},w&&I!==void 0&&(this.H.OSID=w,this.H.OAID=I),this.F=this.X,this.I=Pu(this,null,this.W),Sr(this)};function Yt(u){if(Ko(u),u.G==3){var _=u.U++,w=On(u.I);if(st(w,"SID",u.K),st(w,"RID",_),st(w,"TYPE","terminate"),is(u,w),_=new rr(u,u.j,_),_.L=2,_.v=Ls(On(w)),w=!1,f.navigator&&f.navigator.sendBeacon)try{w=f.navigator.sendBeacon(_.v.toString(),"")}catch{}!w&&f.Image&&(new Image().src=_.v,w=!0),w||(_.g=ju(_.j,null),_.g.ea(_.v)),_.F=Date.now(),at(_)}Ru(u)}function lr(u){u.g&&(Sl(u),u.g.cancel(),u.g=null)}function Ko(u){lr(u),u.u&&(f.clearTimeout(u.u),u.u=null),Xo(u),u.h.cancel(),u.s&&(typeof u.s=="number"&&f.clearTimeout(u.s),u.s=null)}function Sr(u){if(!jn(u.h)&&!u.s){u.s=!0;var _=u.Ga;Me||te(),B||(Me(),B=!0),le.add(_,u),u.B=0}}function Lf(u,_){return vu(u.h)>=u.h.j-(u.s?1:0)?!1:u.s?(u.i=_.D.concat(u.i),!0):u.G==1||u.G==2||u.B>=(u.Va?0:u.Wa)?!1:(u.s=er(E(u.Ga,u,_),Au(u,u.B)),u.B++,!0)}n.Ga=function(u){if(this.s)if(this.s=null,this.G==1){if(!u){this.U=Math.floor(1e5*Math.random()),u=this.U++;const F=new rr(this,this.j,u);let q=this.o;if(this.S&&(q?(q=C(q),b(q,this.S)):q=this.S),this.m!==null||this.O||(F.H=q,q=null),this.P)e:{for(var _=0,w=0;w<this.i.length;w++){t:{var I=this.i[w];if("__data__"in I.map&&(I=I.map.__data__,typeof I=="string")){I=I.length;break t}I=void 0}if(I===void 0)break;if(_+=I,4096<_){_=w;break e}if(_===4096||w===this.i.length-1){_=w+1;break e}}_=1e3}else _=1e3;_=zs(this,F,_),w=On(this.I),st(w,"RID",u),st(w,"CVER",22),this.D&&st(w,"X-HTTP-Session-Id",this.D),is(this,w),q&&(this.O?_="headers="+encodeURIComponent(String(ss(q)))+"&"+_:this.m&&Us(w,this.m,q)),Tl(this.h,F),this.Ua&&st(w,"TYPE","init"),this.P?(st(w,"$req",_),st(w,"SID","null"),F.T=!0,zo(F,w,null)):zo(F,w,_),this.G=2}}else this.G==3&&(u?Qo(this,u):this.i.length==0||jn(this.h)||Qo(this))};function Qo(u,_){var w;_?w=_.l:w=u.U++;const I=On(u.I);st(I,"SID",u.K),st(I,"RID",w),st(I,"AID",u.T),is(u,I),u.m&&u.o&&Us(I,u.m,u.o),w=new rr(u,u.j,w,u.B+1),u.m===null&&(w.H=u.o),_&&(u.i=_.D.concat(u.i)),_=zs(u,w,1e3),w.I=Math.round(.5*u.wa)+Math.round(.5*u.wa*Math.random()),Tl(u.h,w),zo(w,I,_)}function is(u,_){u.H&&fe(u.H,function(w,I){st(_,I,w)}),u.l&&Os({},function(w,I){st(_,I,w)})}function zs(u,_,w){w=Math.min(u.i.length,w);var I=u.l?E(u.l.Na,u.l,u):null;e:{var F=u.i;let q=-1;for(;;){const ie=["count="+w];q==-1?0<w?(q=F[0].g,ie.push("ofs="+q)):q=0:ie.push("ofs="+q);let nt=!0;for(let Rt=0;Rt<w;Rt++){let He=F[Rt].g;const Ut=F[Rt].map;if(He-=q,0>He)q=Math.max(0,F[Rt].g-100),nt=!1;else try{Nu(Ut,ie,"req"+He+"_")}catch{I&&I(Ut)}}if(nt){I=ie.join("&");break e}}}return u=u.i.splice(0,w),_.D=u,I}function Hi(u){if(!u.g&&!u.u){u.Y=1;var _=u.Fa;Me||te(),B||(Me(),B=!0),le.add(_,u),u.v=0}}function Yo(u){return u.g||u.u||3<=u.v?!1:(u.Y++,u.u=er(E(u.Fa,u),Au(u,u.v)),u.v++,!0)}n.Fa=function(){if(this.u=null,Su(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var u=2*this.R;this.j.info("BP detection timer enabled: "+u),this.A=er(E(this.ab,this),u)}},n.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,xt(10),lr(this),Su(this))};function Sl(u){u.A!=null&&(f.clearTimeout(u.A),u.A=null)}function Su(u){u.g=new rr(u,u.j,"rpc",u.Y),u.m===null&&(u.g.H=u.o),u.g.O=0;var _=On(u.qa);st(_,"RID","rpc"),st(_,"SID",u.K),st(_,"AID",u.T),st(_,"CI",u.F?"0":"1"),!u.F&&u.ja&&st(_,"TO",u.ja),st(_,"TYPE","xmlhttp"),is(u,_),u.m&&u.o&&Us(_,u.m,u.o),u.L&&(u.g.I=u.L);var w=u.g;u=u.ia,w.L=1,w.v=Ls(On(_)),w.m=null,w.P=!0,xl(w,u)}n.Za=function(){this.C!=null&&(this.C=null,lr(this),Yo(this),xt(19))};function Xo(u){u.C!=null&&(f.clearTimeout(u.C),u.C=null)}function Jo(u,_){var w=null;if(u.g==_){Xo(u),Sl(u),u.g=null;var I=2}else if(dn(u.h,_))w=_.D,wu(u.h,_),I=1;else return;if(u.G!=0){if(_.o)if(I==1){w=_.m?_.m.length:0,_=Date.now()-_.F;var F=u.B;I=Mi(),At(I,new Lo(I,w)),Sr(u)}else Hi(u);else if(F=_.s,F==3||F==0&&0<_.X||!(I==1&&Lf(u,_)||I==2&&Yo(u)))switch(w&&0<w.length&&(_=u.h,_.i=_.i.concat(w)),F){case 1:os(u,5);break;case 4:os(u,10);break;case 3:os(u,6);break;default:os(u,2)}}}function Au(u,_){let w=u.Ta+Math.floor(Math.random()*u.cb);return u.isActive()||(w*=2),w*_}function os(u,_){if(u.j.info("Error code "+_),_==2){var w=E(u.fb,u),I=u.Xa;const F=!I;I=new ns(I||"//www.google.com/images/cleardot.gif"),f.location&&f.location.protocol=="http"||$i(I,"https"),Ls(I),F?Of(I.toString(),w):Cu(I.toString(),w)}else xt(2);u.G=0,u.l&&u.l.sa(_),Ru(u),Ko(u)}n.fb=function(u){u?(this.j.info("Successfully pinged google.com"),xt(2)):(this.j.info("Failed to ping google.com"),xt(1))};function Ru(u){if(u.G=0,u.ka=[],u.l){const _=xu(u.h);(_.length!=0||u.i.length!=0)&&(L(u.ka,_),L(u.ka,u.i),u.h.i.length=0,U(u.i),u.i.length=0),u.l.ra()}}function Pu(u,_,w){var I=w instanceof ns?On(w):new ns(w);if(I.g!="")_&&(I.g=_+"."+I.g),Ds(I,I.s);else{var F=f.location;I=F.protocol,_=_?_+"."+F.hostname:F.hostname,F=+F.port;var q=new ns(null);I&&$i(q,I),_&&(q.g=_),F&&Ds(q,F),w&&(q.l=w),I=q}return w=u.D,_=u.ya,w&&_&&st(I,w,_),st(I,"VER",u.la),is(u,I),I}function ju(u,_,w){if(_&&!u.J)throw Error("Can't create secondary domain capable XhrIo object.");return _=u.Ca&&!u.pa?new mt(new rs({eb:w})):new mt(u.pa),_.Ha(u.J),_}n.isActive=function(){return!!this.l&&this.l.isActive(this)};function Al(){}n=Al.prototype,n.ua=function(){},n.ta=function(){},n.sa=function(){},n.ra=function(){},n.isActive=function(){return!0},n.Na=function(){};function Zo(){}Zo.prototype.g=function(u,_){return new hn(u,_)};function hn(u,_){St.call(this),this.g=new kl(_),this.l=u,this.h=_&&_.messageUrlParams||null,u=_&&_.messageHeaders||null,_&&_.clientProtocolHeaderRequired&&(u?u["X-Client-Protocol"]="webchannel":u={"X-Client-Protocol":"webchannel"}),this.g.o=u,u=_&&_.initMessageHeaders||null,_&&_.messageContentType&&(u?u["X-WebChannel-Content-Type"]=_.messageContentType:u={"X-WebChannel-Content-Type":_.messageContentType}),_&&_.va&&(u?u["X-WebChannel-Client-Profile"]=_.va:u={"X-WebChannel-Client-Profile":_.va}),this.g.S=u,(u=_&&_.Sb)&&!ee(u)&&(this.g.m=u),this.v=_&&_.supportsCrossDomainXhr||!1,this.u=_&&_.sendRawJson||!1,(_=_&&_.httpSessionIdParam)&&!ee(_)&&(this.g.D=_,u=this.h,u!==null&&_ in u&&(u=this.h,_ in u&&delete u[_])),this.j=new Ar(this)}M(hn,St),hn.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},hn.prototype.close=function(){Yt(this.g)},hn.prototype.o=function(u){var _=this.g;if(typeof u=="string"){var w={};w.__data__=u,u=w}else this.u&&(w={},w.__data__=fl(u),u=w);_.i.push(new yu(_.Ya++,u)),_.G==3&&Sr(_)},hn.prototype.N=function(){this.g.l=null,delete this.j,Yt(this.g),delete this.g,hn.aa.N.call(this)};function Ou(u){br.call(this),u.__headers__&&(this.headers=u.__headers__,this.statusCode=u.__status__,delete u.__headers__,delete u.__status__);var _=u.__sm__;if(_){e:{for(const w in _){u=w;break e}u=void 0}(this.i=u)&&(u=this.i,_=_!==null&&u in _?_[u]:void 0),this.data=_}else this.data=u}M(Ou,br);function Du(){Mo.call(this),this.status=1}M(Du,Mo);function Ar(u){this.g=u}M(Ar,Al),Ar.prototype.ua=function(){At(this.g,"a")},Ar.prototype.ta=function(u){At(this.g,new Ou(u))},Ar.prototype.sa=function(u){At(this.g,new Du)},Ar.prototype.ra=function(){At(this.g,"b")},Zo.prototype.createWebChannel=Zo.prototype.g,hn.prototype.send=hn.prototype.o,hn.prototype.open=hn.prototype.m,hn.prototype.close=hn.prototype.close,XE=function(){return new Zo},YE=function(){return Mi()},QE=Ir,$m={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},Fo.NO_ERROR=0,Fo.TIMEOUT=8,Fo.HTTP_ERROR=6,Gd=Fo,pu.COMPLETE="complete",KE=pu,Do.EventType=Bn,Bn.OPEN="a",Bn.CLOSE="b",Bn.ERROR="c",Bn.MESSAGE="d",St.prototype.listen=St.prototype.K,dc=Do,mt.prototype.listenOnce=mt.prototype.L,mt.prototype.getLastError=mt.prototype.Ka,mt.prototype.getLastErrorCode=mt.prototype.Ba,mt.prototype.getStatus=mt.prototype.Z,mt.prototype.getResponseJson=mt.prototype.Oa,mt.prototype.getResponseText=mt.prototype.oa,mt.prototype.send=mt.prototype.ea,mt.prototype.setWithCredentials=mt.prototype.Ha,GE=mt}).apply(typeof jd<"u"?jd:typeof self<"u"?self:typeof window<"u"?window:{});const G0="@firebase/firestore",K0="4.8.0";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Se(n,e,t){let r="Unexpected state";typeof e=="string"?r=e:t=e,JE(n,r,t)}function JE(n,e,t){let r=`FIRESTORE (${Za}) INTERNAL ASSERTION FAILED: ${e} (ID: ${n.toString(16)})`;if(t!==void 0)try{r+=" CONTEXT: "+JSON.stringify(t)}catch{r+=" CONTEXT: "+t}throw bs(r),new Error(r)}function tt(n,e,t,r){let i="Unexpected state";typeof t=="string"?i=t:r=t,n||JE(e,i,r)}function Pe(n,e){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mg{static newId(){const e="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",t=62*Math.floor(4.129032258064516);let r="";for(;r.length<20;){const i=k2(40);for(let a=0;a<i.length;++a)r.length<20&&i[a]<t&&(r+=e.charAt(i[a]%62))}return r}}function De(n,e){return n<e?-1:n>e?1:0}function Wm(n,e){let t=0;for(;t<n.length&&t<e.length;){const r=n.codePointAt(t),i=e.codePointAt(t);if(r!==i){if(r<128&&i<128)return De(r,i);{const a=e1(),l=S2(a.encode(Y0(n,t)),a.encode(Y0(e,t)));return l!==0?l:De(r,i)}}t+=r>65535?2:1}return De(n.length,e.length)}function Y0(n,e){return n.codePointAt(e)>65535?n.substring(e,e+2):n.substring(e,e+1)}function S2(n,e){for(let t=0;t<n.length&&t<e.length;++t)if(n[t]!==e[t])return De(n[t],e[t]);return De(n.length,e.length)}function Fa(n,e,t){return n.length===e.length&&n.every(((r,i)=>t(r,e[i])))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rf{constructor(e,t,r,i,a){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=r,this.documentUpdates=i,this.resolvedLimboDocuments=a}static createSynthesizedRemoteEventForCurrentChange(e,t,r){const i=new Map;return i.set(e,Zc.createSynthesizedTargetChangeForCurrentChange(e,t,r)),new rf(Re.min(),i,new kt(De),Is(),$e())}}class Zc{constructor(e,t,r,i,a){this.resumeToken=e,this.current=t,this.addedDocuments=r,this.modifiedDocuments=i,this.removedDocuments=a}static createSynthesizedTargetChangeForCurrentChange(e,t,r){return new Zc(r,t,$e(),$e(),$e())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ur{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new xe(X.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new xe(X.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return De(this._lat,e._lat)||De(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:Ur._jsonSchemaVersion}}static fromJSON(e){if(Xc(e,Ur._jsonSchema))return new Ur(e.latitude,e.longitude)}}Ur._jsonSchemaVersion="firestore/geoPoint/1.0",Ur._jsonSchema={type:Nt("string",Ur._jsonSchemaVersion),latitude:Nt("number"),longitude:Nt("number")};/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vr{constructor(e,t){this.bucket=e,this.path_=t}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,t){let r;try{r=vr.makeFromUrl(e,t)}catch{return new vr(e,"")}if(r.path==="")return r;throw E6(e)}static makeFromUrl(e,t){let r=null;const i="([A-Za-z0-9.\\-_]+)";function a(G){G.path.charAt(G.path.length-1)==="/"&&(G.path_=G.path_.slice(0,-1))}const l="(/(.*))?$",f=new RegExp("^gs://"+i+l,"i"),p={bucket:1,path:3};function m(G){G.path_=decodeURIComponent(G.path)}const v="v[A-Za-z0-9_]+",x=t.replace(/[.]/g,"\\."),E="(/([^?#]*).*)?$",A=new RegExp(`^https?://${x}/${v}/b/${i}/o${E}`,"i"),M={bucket:1,path:3},U=t===pI?"(?:storage.googleapis.com|storage.cloud.google.com)":t,L="([^?#]*)",Q=new RegExp(`^https?://${U}/${i}/${L}`,"i"),oe=[{regex:f,indices:p,postModify:a},{regex:A,indices:M,postModify:m},{regex:Q,indices:{bucket:1,path:2},postModify:m}];for(let G=0;G<oe.length;G++){const ce=oe[G],fe=ce.regex.exec(e);if(fe){const j=fe[ce.indices.bucket];let C=fe[ce.indices.path];C||(C=""),r=new vr(j,C),ce.postModify(r);break}}if(r==null)throw x6(e);return r}}class b6{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function I6(n,e,t){let r=1,i=null,a=null,l=!1,f=0;function p(){return f===2}let m=!1;function v(...L){m||(m=!0,e.apply(null,L))}function x(L){i=setTimeout(()=>{i=null,n(A,p())},L)}function E(){a&&clearTimeout(a)}function A(L,...Q){if(m){E();return}if(L){E(),v.call(null,L,...Q);return}if(p()||l){E(),v.call(null,L,...Q);return}r<64&&(r*=2);let oe;f===1?(f=2,oe=0):oe=(r+Math.random())*1e3,x(oe)}let M=!1;function U(L){M||(M=!0,E(),!m&&(i!==null?(L||(f=2),clearTimeout(i),x(0)):L||(f=1)))}return x(0),a=setTimeout(()=>{l=!0,U(!0)},t),U}function C6(n){n(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function IV(n=Yc(),e){n=it(n);const t=Io(n,"app-check");if(Af().initialized||aV(),ny()&&ry().then(i=>console.log(`App Check debug token: ${i}. You will need to add it to your app's App Check settings in the Firebase console for it to work.`)),t.isInitialized()){const i=t.getImmediate(),a=t.getOptions();if(a.isTokenAutoRefreshEnabled===e.isTokenAutoRefreshEnabled&&a.provider.isEqual(e.provider))return i;throw Sn.create("already-initialized",{appName:n.name})}const r=t.initialize({options:e});return CV(n,e.provider,e.isTokenAutoRefreshEnabled),Ft(n).isTokenAutoRefreshEnabled&&CI(r,"INTERNAL",()=>{}),r}function CV(n,e,t=!1){const r=q6(n,Object.assign({},_I));r.activated=!0,r.provider=e,r.cachedTokenPromise=iV(n).then(i=>(i&&Aa(i)&&(r.token=i,kI(n,{token:i.token})),i)),r.isTokenAutoRefreshEnabled=t&&n.automaticDataCollectionEnabled,!n.automaticDataCollectionEnabled&&t&&ui.warn("`isTokenAutoRefreshEnabled` is true but `automaticDataCollectionEnabled` was set to false during `initializeApp()`. This blocks automatic token refresh."),r.provider.initialize(n)}const NV="app-check",aE="app-check-internal";function kV(){Wr(new xr(NV,n=>{const e=n.getProvider("app").getImmediate(),t=n.getProvider("heartbeat");return fV(e,t)},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((n,e,t)=>{n.getProvider(aE).initialize()})),Wr(new xr(aE,n=>{const e=n.getProvider("app-check").getImmediate();return pV(e)},"PUBLIC").setInstantiationMode("EXPLICIT")),zn(mV,gV)}kV();const SV={apiKey:"AIzaSyBwptsaCYLtLGdKIh1ut84-FZnt8OiToYo",authDomain:"groupby-me.firebaseapp.com",databaseURL:"https://groupby-me-default-rtdb.firebaseio.com/",projectId:"groupby-me",storageBucket:"groupby-me.firebasestorage.app",messagingSenderId:"106122999914",appId:"1:106122999914:web:a7ad014f757346abb93213"},hu=$E(SV),Cc=d6(hu),Wd=yj(hu);U6(hu);const ac=B4(hu);let lE;typeof window<"u"&&!lE&&(lE=IV(hu,{provider:new sy("6Ld25xgsAAAAAOIkK9dXA48fiJCUR0fPxwyBqT4e"),isTokenAutoRefreshEnabled:!0}));function Om({className:n,type:e,...t}){return d.jsx("input",{type:e,"data-slot":"input",className:kg("file:text-foreground placeholder:text-muted-foreground selection:bg-primary selection:text-primary-foreground dark:bg-input/30 border-input flex h-9 w-full min-w-0 rounded-md border px-3 py-1 text-base bg-input-background transition-[color,box-shadow] outline-none file:inline-flex file:h-7 file:border-0 file:bg-transparent file:text-sm file:font-medium disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm","focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px]","aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",n),...t})}function AV({isOpen:n,onClose:e,onLoginSuccess:t}){const[r,i]=re.useState("login"),[a,l]=re.useState(""),[f,p]=re.useState(""),[m,v]=re.useState(""),[x,E]=re.useState(""),[A,M]=re.useState(""),[U,L]=re.useState(!1);if(!n)return null;const Q=()=>{E(""),M(""),p("")},ee=async G=>{G.preventDefault(),L(!0),M(""),E("");try{if(r==="login")await KM(Cc,a,f),t();else if(r==="register"){const ce=await GM(Cc,a,f);m&&await YM(ce.user,{displayName:m}),t()}else await HM(Cc,a),E("Enviamos um link para redefinir sua senha."),i("login")}catch(ce){M(ce?.message||"Não foi possível concluir a ação. Tente novamente.")}finally{L(!1)}},oe={login:"Entrar",register:"Criar conta",reset:"Recuperar senha"};return d.jsx("div",{className:"fixed inset-0 z-50 flex items-center justify-center px-4 py-6 bg-black/60 backdrop-blur-sm",children:d.jsxs("div",{className:"w-full max-w-md bg-white rounded-2xl shadow-2xl p-8 relative",children:[d.jsx("button",{onClick:()=>{e(),i("login"),l(""),p(""),v(""),Q()},className:"absolute top-4 right-4 text-gray-500 hover:text-gray-700","aria-label":"Fechar",children:"X"}),d.jsx("h2",{className:"text-2xl font-semibold text-gray-900 mb-6",children:oe[r]}),d.jsxs("form",{className:"space-y-4",onSubmit:ee,children:[r==="register"&&d.jsxs("div",{children:[d.jsx("label",{className:"text-sm text-gray-700 mb-1 block",children:"Nome"}),d.jsx(Om,{type:"text",placeholder:"Seu nome",value:m,onChange:G=>v(G.target.value),required:!0})]}),d.jsxs("div",{children:[d.jsx("label",{className:"text-sm text-gray-700 mb-1 block",children:"E-mail"}),d.jsx(Om,{type:"email",placeholder:"voce@email.com",value:a,onChange:G=>l(G.target.value),required:!0})]}),r!=="reset"&&d.jsxs("div",{children:[d.jsx("label",{className:"text-sm text-gray-700 mb-1 block",children:"Senha"}),d.jsx(Om,{type:"password",placeholder:"Sua senha",value:f,onChange:G=>p(G.target.value),required:!0})]}),A&&d.jsx("p",{className:"text-sm text-red-600",children:A}),x&&d.jsx("p",{className:"text-sm text-green-600",children:x}),d.jsx(Xe,{type:"submit",className:"w-full bg-blue-600 hover:bg-blue-700",disabled:U,children:U?"Processando...":oe[r]})]}),d.jsxs("div",{className:"mt-4 text-sm text-gray-600 flex items-center justify-between",children:[r!=="reset"?d.jsx("button",{type:"button",onClick:()=>{i("reset"),Q()},className:"hover:text-gray-900",children:"Esqueci minha senha"}):d.jsx("button",{type:"button",onClick:()=>{i("login"),Q()},className:"hover:text-gray-900",children:"Voltar para login"}),d.jsx("button",{type:"button",onClick:()=>{i(r==="login"?"register":"login"),Q()},className:"hover:text-gray-900",children:r==="login"?"Criar conta":"Já tenho conta"})]})]})})}function RV(){const[n,e]=re.useState(!1),[t,r]=re.useState(null),[i,a]=re.useState(!1),[l,f]=re.useState(!1),[p,m]=re.useState(null),[v,x]=re.useState(!1),[E,A]=re.useState(!1),[M,U]=re.useState(!1),[L,Q]=re.useState(!1),[ee,oe]=re.useState(!1),[G,ce]=re.useState(void 0),[fe,j]=re.useState(!1),[C,S]=re.useState(!1),b=re.useRef({}),[R,D]=re.useState([]);re.useEffect(()=>{const B=ZM(Cc,V=>{V?(e(!0),r({id:V.uid,name:V.displayName||V.email||"Usuário",email:V.email,type:"user",points:0,level:1})):(e(!1),r(null))}),le=zw(Wd,"pins"),te=jj(le,V=>{const H=V.docs.map(he=>{const pe=he.data(),je=pe.createdAt?.toDate?pe.createdAt.toDate():new Date(pe.createdAt??Date.now());return{id:he.id,type:pe.type,name:pe.name,lat:pe.lat,lng:pe.lng,address:pe.address,createdBy:pe.createdBy,createdAt:je,avatar:pe.avatar,description:pe.description,businessInfo:pe.businessInfo,stats:pe.stats??{views:0,chatsStarted:0,messages:0},reported:!!pe.reported,moderationStatus:pe.moderationStatus}});D(H);const ae=new Set(H.map(he=>he.id));Object.entries(b.current).forEach(([he,pe])=>{ae.has(he)||(pe(),delete b.current[he])}),H.forEach(he=>{if(b.current[he.id])return;const pe=oc(ac,`pinStats/${he.id}`),je=jb(pe,be=>{const Ue=be.val();Ue&&D(Ke=>Ke.map(rt=>rt.id===he.id?{...rt,stats:{...rt.stats,...Ue}}:rt))});b.current[he.id]=je})},V=>{console.error("Error loading pins from Firestore",V)});return()=>{B(),te(),Object.values(b.current).forEach(V=>V()),b.current={}}},[]);const k=async B=>{m(B);try{const le=og(Wd,"pins",B.id);await Hw(le,{"stats.views":Kw(1)}),await Px(oc(ac,`pinStats/${B.id}/views`),te=>(te||0)+1)}catch(le){console.error("Failed to increment views",le)}n&&t?.id===B.createdBy?j(!0):B.type==="business"||B.type==="public"?x(!0):A(!0)},Je=B=>{if(p){const le=og(Wd,"pins",p.id);Hw(le,{"stats.chatsStarted":Kw(1)}).catch(te=>{console.error("Failed to increment chat counter",te)}),Px(oc(ac,`pinStats/${p.id}/chatsStarted`),te=>(te||0)+1).catch(te=>{console.error("Failed to increment chat counter (RTDB)",te)})}x(!1),A(!0),B&&ce(B)},Ze=B=>{const le=B.type!=="personal"&&B.businessInfo?{...B.businessInfo,products:(B.businessInfo.products||[]).filter(Boolean),services:(B.businessInfo.services||[]).filter(Boolean),categories:(B.businessInfo.categories||[]).filter(Boolean)}:null,te={type:B.type,name:B.name,lat:B.lat,lng:B.lng,address:B.address,createdBy:t?.id||"user",createdAt:new Date,description:B.description,stats:{views:0,chatsStarted:0,messages:0},reported:!1},V=le?{...te}:te,H=le?{...te,businessInfo:le,createdAt:Gw()}:{...te,createdAt:Gw()};Pj(zw(Wd,"pins"),H).then(ae=>{const he=le?{...te,businessInfo:le,createdAt:Rx()}:{...te,createdAt:Rx()};Ax(oc(ac,`pins/${ae.id}`),he).then(()=>Ax(oc(ac,`pinStats/${ae.id}`),V.stats).catch(pe=>{console.error("Failed to seed stats in Realtime Database",pe)})).catch(pe=>{console.error("Failed to create pin in Realtime Database",pe)}),f(!1)}).catch(ae=>{console.error("Failed to create pin in Firestore",ae)})},We=()=>S(!0),Me=()=>{eL(Cc).catch(B=>{console.error("Failed to logout",B)})};return d.jsx("div",{className:"h-screen flex flex-col overflow-hidden bg-gray-900",children:fe&&p?d.jsx(DS,{pin:p,onBack:()=>{j(!1),m(null)},onUpdate:B=>{D(R.map(le=>le.id===p.id?{...le,...B}:le))}}):d.jsxs(d.Fragment,{children:[d.jsx(IS,{isLoggedIn:n,currentUser:t,onMenuClick:()=>a(!0),onNotificationClick:()=>U(!0),onLogin:We,onLogout:Me}),d.jsx("div",{className:"flex-1 relative",children:d.jsx(xS,{pins:R,onPinClick:k,onCreatePin:()=>f(!0),isLoggedIn:n})}),d.jsx(bS,{isOpen:i,onClose:()=>a(!1),isLoggedIn:n,currentUser:t,onOpenRewards:()=>{Q(!0),a(!1)},onOpenModeration:()=>{oe(!0),a(!1)}}),d.jsx(CS,{isOpen:l,onClose:()=>f(!1),onCreate:Ze,currentUser:t}),p&&d.jsx(NS,{isOpen:v,onClose:()=>{x(!1),m(null)},pin:p,onStartChat:Je,isLoggedIn:n,onLogin:We}),p&&d.jsx(SS,{isOpen:E,onClose:()=>{A(!1),m(null),ce(void 0)},pin:p,isLoggedIn:n,currentUser:t,onLogin:We,interest:G}),d.jsx(RS,{isOpen:M,onClose:()=>U(!1),currentUser:t}),d.jsx(PS,{isOpen:L,onClose:()=>Q(!1),currentUser:t}),d.jsx(jS,{isOpen:ee,onClose:()=>oe(!1),pins:R,onModerate:(B,le)=>{D(R.map(te=>te.id===B?{...te,moderationStatus:le,reported:!1}:te))}}),d.jsx(AV,{isOpen:C,onClose:()=>S(!1),onLoginSuccess:()=>S(!1)})]})})}BC.createRoot(document.getElementById("root")).render(d.jsx(RV,{}));
